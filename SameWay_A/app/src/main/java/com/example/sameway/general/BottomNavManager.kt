package com.example.sameway.general
...
class BottomNavManager @AssistedInject constructor(@Assisted private val fragmentManager: FragmentManager, @Named("container id") private val containerId: Int, @Assisted private val bottomNavigationView: BottomNavigationView)
{
  ...
  private val navGraphIds = listOf(R.navigation.nav1,R.navigation.nav2,R.navigation.nav3)
  ...
  private var navHistory = BottomNavHistory().apply { push(R.id.nav2) }
...
//      }
  ...
  {
    return bottomNavigationView.selectedItemId == R.id.nav2
  }
